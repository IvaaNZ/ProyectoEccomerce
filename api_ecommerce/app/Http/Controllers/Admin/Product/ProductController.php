...
class ProductController extends Controller
{
    ...
    public function config(){
        ...
        $categories_first = Categorie::where('status',1)->where("categorie_second_id",NULL)->where("categorie_third_id",NULL)->get();
        $categories_seconds = Categorie::where('status',1)->where("categorie_second_id","<>",NULL)->where("categorie_third_id",NULL)->get();
        $categories_thirds = Categorie::where('status',1)->where("categorie_second_id","<>",NULL)->where("categorie_third_id",'<>',NULL)->get();
    ...
    public function imagens(Request $request){
        ...
        if ($request->hasFile('file_imagen_two')) {
            $path = Storage::putFile('products',$request->file('file_imagen_two'));
        }
